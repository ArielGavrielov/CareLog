...
const AvatarComponent = (_a) => {
    ...
    const PlaceholderContent = (renderPlaceholderContent &&
        ...
        (icon && (<Icon 
        //@ts-ignore
        style={iconStyle && iconStyle} color={icon.color || 'white'} name={icon.name || 'user'} size={icon.size || iconSize} type={icon.type && icon.type}/>));
    // @ts-ignore
    ...
    //@ts-ignore
    containerStyle={imageContainerStyle} source={source} borderRadius={rounded ? width / 2 : undefined} {...imageProps} style={StyleSheet.flatten([
            styles.avatar,
